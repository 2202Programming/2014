...
#define VARRIABLEAUTOPIDFIRE 0.92 // 0.85 //Change this varriable to test lower and lower shooter speed in autonomous mode. Normal is 1.00
#define RIGHT 5000
#define HOME 5
#define ARMING 0
...
#define FIRE  225 // 200 //260 Usexd at Terra Hote 
...
ShooterControl::ShooterControl() {
	...
	maxValue = 0;
	loadingBall = false;
	LED1 = new Relay(1, Relay::kForwardOnly); //RED
	LED2 = new Relay(3, Relay::kForwardOnly); //BLUE
